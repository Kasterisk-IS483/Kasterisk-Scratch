          ...
          return (
            <SafeAreaView style={{ flex: 1 }}>
              ...
              <DrawerItem
                ...
                icon={() => (
                  <Image
                    source={require("../../assets/cluster_icon.png")}
      ...
      >
        ...
        <Drawer.Screen
          ...
          options={{
            ...
            drawerIcon: () => (
              <Image
                source={require("../../assets/deployment_icon.png")}
                style={commonStyles.icon}
              />
            ),
            title: "Workloads",
        ...
        <Drawer.Screen
          ...
          options={{
            ...
            drawerIcon: () => (
              <Image
                source={require("../../assets/replicaset_icon.png")}
                style={commonStyles.icon}
              />
            ),
            title: "Workloads",
        ...
        <Drawer.Screen
          ...
          options={{
            ...
            drawerIcon: () => (
              <Image
                source={require("../../assets/pod_icon.png")}
                style={commonStyles.icon}
              />
            ),
            title: "Workloads",
